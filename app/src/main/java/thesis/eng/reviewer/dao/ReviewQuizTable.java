...
public class ReviewQuizTable {
    ...
    private Long points;
    @Generated(hash = 828972541)
    public ReviewQuizTable(Long id, @NotNull Long categoryID,
    ...
    @Generated(hash = 1459173206)
    public ReviewQuizTable() {
    }
    public Long getId() {
        return this.id;
    }
